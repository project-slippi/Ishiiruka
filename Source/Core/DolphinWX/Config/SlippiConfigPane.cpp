...
void SlippiNetplayConfigPane::InitializeGUI()
{
	...
	sSlippiOnlineSettings->Add(m_slippi_enable_port_mapping_checkbox, wxGBPosition(2, 0), wxDefaultSpan,
	                           wxALIGN_CENTER_VERTICAL);
...
void SlippiNetplayConfigPane::LoadGUIValues()
{
	...
	m_slippi_enable_port_mapping_checkbox->SetValue(startup_params.m_slippiEnablePortMapping);
...
void SlippiNetplayConfigPane::BindEvents()
{
	...
	m_slippi_enable_port_mapping_checkbox->Bind(wxEVT_CHECKBOX, &SlippiNetplayConfigPane::OnEnablePortMappingToggle,
	                                            this);
...
void SlippiNetplayConfigPane::OnEnablePortMappingToggle(wxCommandEvent& event)
{
	SConfig::GetInstance().m_slippiEnablePortMapping = m_slippi_enable_port_mapping_checkbox->GetValue();
}
