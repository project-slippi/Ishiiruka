...
void SlippiNetplayConfigPane::InitializeGUI()
{
	...
	m_replay_directory_picker =
		new wxDirPickerCtrl(this, wxID_ANY, wxEmptyString, _("Slippi Replay Folder:"), wxDefaultPosition,
	...
	sSlippiOnlineSettings->Add(m_slippi_delay_frames_txt, wxGBPosition(0, 0), wxDefaultSpan,
...
void SlippiNetplayConfigPane::BindEvents()
{
	...
	m_slippi_force_netplay_lan_ip_checkbox->Bind(wxEVT_CHECKBOX,
		                                            &SlippiNetplayConfigPane::OnForceNetplayLanIpToggle, this);
	m_slippi_netplay_lan_ip_ctrl->Bind(wxEVT_TEXT, &SlippiNetplayConfigPane::OnNetplayLanIpChanged, this);

	m_reduce_timing_dispersion_checkbox->Bind(wxEVT_CHECKBOX,
		                                        &SlippiNetplayConfigPane::OnReduceTimingDispersionToggle, this);
}
