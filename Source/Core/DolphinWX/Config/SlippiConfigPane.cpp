...
void SlippiConfigPane::InitializeGUI()
{
	...
	m_slippi_display_name_txt = new wxStaticText(this, wxID_ANY, _("Display Name:"));
	m_slippi_display_name_ctrl = new wxTextCtrl(this, wxID_ANY, "Default Display Name", wxDefaultPosition, wxSize(300, -1));
	m_slippi_display_name_ctrl->SetToolTip(_("Dispaly Name shown in-game"));
	...
	sSlippiOnlineSettings->Add(m_slippi_display_name_txt, wxGBPosition(1, 0), wxDefaultSpan, wxALIGN_CENTER_VERTICAL);
	sSlippiOnlineSettings->Add(m_slippi_display_name_ctrl, wxGBPosition(1, 1), wxDefaultSpan, wxALIGN_LEFT);
...
void SlippiConfigPane::LoadGUIValues()
{
	...
	m_slippi_display_name_ctrl->SetValue(startup_params.m_slippiOnlineDisplayName);
#endif
}
...
void SlippiConfigPane::BindEvents()
{
	...
	m_slippi_display_name_ctrl->Bind(wxEVT_TEXT, &SlippiConfigPane::OnDisplayNameChanged, this);
#endif
}
