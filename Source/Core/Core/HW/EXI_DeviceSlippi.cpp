...
void CEXISlippi::prepareOpponentInputs(u8 *payload)
{
	...
	int32_t minFrameSent = *std::min_element(latestFrameSent, latestFrameSent + SLIPPI_REMOTE_PLAYER_MAX);
	slippi_netplay->DropOldRemoteInputs(minFrameSent);
}
